...
export default connect(
    ...
    <Fragment>
        <h1 className="text-light mb-0">Do you like <span className="text-monospace">create-electron-app</span>?</h1>
        <p className="text-light mb-3"><small>This is just an excuse to show you how redux components work...</small></p>
        ...
        <div className={`row justify-content-center ${props.className}`}>
            <div className="col-6 text-center">
                <div className="btn-group">
                    ...
                    { props.feel === 'good' && <span className={style.smiley} role="img" aria-label="happy">🎉</span> }

                    { props.feel === 'bad' && <span className={style.smiley} role="img" aria-label="sad">😥</span> }
                </div>
            </div>
        </div>
    </Fragment>
